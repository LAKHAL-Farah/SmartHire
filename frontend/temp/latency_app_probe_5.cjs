...
(async()=>{
  ...
  for(let i=1;i<=5;i++){
    ...
    await page.fill('.verbal-answer-section .answer-text', 'IaaS gives infrastructure, PaaS gives managed platform/runtime, and SaaS gives complete software to users.');
    const t0 = Date.now();
